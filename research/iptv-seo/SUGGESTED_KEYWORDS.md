...
| FR / CH regions | `iptv alsace` / `iptv bretagne` / `iptv corse` / `iptv valais` | Regional commercial | `alsace-iptv.fr`, `bretagne-iptv.fr`, `corse-iptv.fr`, `provence-iptv.fr`, `valais-iptv.ch`, `vaud-iptv.ch` |
