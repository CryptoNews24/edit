...
| More regions | `iptv normandie` / `iptv savoie` / `iptv bayern` / `iptv brabant` | Regional commercial | `normandie-iptv.fr`, `savoie-iptv.fr`, `bayern-iptv.de`, `sachsen-iptv.de`, `brabant-iptv.nl` |
