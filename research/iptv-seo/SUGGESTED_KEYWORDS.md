...
| More regions | `iptv nrw` / `iptv hessen` / `iptv languedoc` / `iptv ticino` / `iptv lapland` | Regional commercial | `nrw-iptv.de`, `hessen-iptv.de`, `languedoc-iptv.fr`, `ticino-iptv.ch`, `lapland-iptv.fi`, `friesland-iptv.nl` |
