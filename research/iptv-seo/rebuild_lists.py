...
def main() -> None:
    ...
    traffic["semrush_refresh"] = {
        ...
        "status": "partial",
        "detail": "Noxtools 15:02 UTC GET login Cloudflare 403 (Just a moment, not HTTP 429). No login POST this hour (15:xx). Did not use Semrush free tools. No invented volumes. Two-word RDAP hunt on CA/US/UK/Nordics not extra .fr. Pair-row and hyphen-joined keywords excluded. Ranked table is RANKED_KEYWORDS.md only.",
        "min_volume": 500,
