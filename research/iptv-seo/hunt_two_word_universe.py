...
STEMS = (
    ...
    "t962z-box",
    "risorangisien-iptv",
    "virychatillonnais-iptv",
    "epinaysenartais-iptv",
    "quincysenartais-iptv",
    "risorangisien-box",
    "t965z-iptv",
    "rk3328z-iptv",
    "t965z-box",
    "boussyantoinais-iptv",
    "varennojarcysien-iptv",
    "soisyen-iptv",
    "crosnesien-iptv",
    "boussyantoinais-box",
    "t972z-iptv",
    ...
    "s905l3z-iptv",
    "rk3326z-box",
    "kremlinbicetrais-iptv",
    "charentonnais-iptv",
    "ablonais-iptv",
    "fresnoisien-iptv",
    "kremlinbicetrais-box",
    "a311dz-iptv",
    "rk3588z-iptv",
    "a311dz-box",
    "balbynien-iptv",
    ...
    "noisysecais-iptv",
    "romainvillois-iptv",
    "montfermeillois-iptv",
    "dugnysien-box",
    "s905y2z-iptv",
    "h728w-iptv",
    "s905y2z-box",
    "lilasien-iptv",
    "neuillyplaisancien-iptv",
    "villepintois-iptv",
    "clichysois-iptv",
    "lilasien-box",
    "s905l2z-iptv",
    ...
    "rk3566w-iptv",
    "h618x-box",
    "villeneuvogarennois-iptv",
    "plessisrobinsonais-iptv",
    "garennois-iptv",
    "sceen-iptv",
    "villeneuvogarennois-box",
    "s905y4z-iptv",
    "a523w-iptv",
    "s905y4z-box",
    "houillais-iptv",
...
def candidates() -> list[str]:
    ...
    _push("tivimate-hamilton.ca", seen, out)
    _push("tivimate-victoria.ca", seen, out)
    _push("tivimate-saskatoon.ca", seen, out)
    _push("tivimate-regina.ca", seen, out)
    _push("tivimate-kelowna.ca", seen, out)
    _push("tivimate-mississauga.ca", seen, out)
    _push("tivimate-brampton.ca", seen, out)
    _push("tivimate-atlanta.us", seen, out)
    _push("tivimate-detroit.us", seen, out)
    _push("tivimate-nashville.us", seen, out)
    _push("tivimate-tampa.us", seen, out)
    _push("tivimate-orlando.us", seen, out)
    _push("charlotte-tivimate.us", seen, out)
    _push("tivimate-portland.us", seen, out)
    _push("tivimate-minneapolis.us", seen, out)
    _push("tivimate-turku.fi", seen, out)
    _push("tivimate-tampere.fi", seen, out)
    _push("tivimate-aarhus.dk", seen, out)
    _push("tivimate-trondheim.no", seen, out)
    ...
    for stem in (
        ...
        for tld in (".ca", ".us", ".dk", ".no", ".se", ".fi"):
            _push(f"{stem}{tld}", seen, out)
    _push("tivimate-laval.ca", seen, out)
    _push("tivimate-gatineau.ca", seen, out)
    _push("tivimate-moncton.ca", seen, out)
    _push("tivimate-memphis.us", seen, out)
    _push("tivimate-baltimore.us", seen, out)
    _push("tivimate-kuopio.fi", seen, out)
    _push("tivimate-lahti.fi", seen, out)
    _push("tivimate-espoo.fi", seen, out)
    _push("tivimate-esbjerg.dk", seen, out)
    _push("tivimate-kristiansand.no", seen, out)
    ...
    for stem in (
        ...
        for tld in (".ca", ".us", ".dk", ".no", ".se", ".fi"):
            _push(f"{stem}{tld}", seen, out)
    _push("tivimate-kamloops.ca", seen, out)
    _push("tivimate-nanaimo.ca", seen, out)
    _push("tivimate-burnaby.ca", seen, out)
    _push("tivimate-surrey.ca", seen, out)
    _push("tivimate-markham.ca", seen, out)
    _push("tivimate-vaughan.ca", seen, out)
    _push("tivimate-abbotsford.ca", seen, out)
    _push("tivimate-tucson.us", seen, out)
    _push("tivimate-fresno.us", seen, out)
    _push("tivimate-elpaso.us", seen, out)
    _push("tivimate-wichita.us", seen, out)
    _push("tivimate-sanantonio.us", seen, out)
    _push("tivimate-sanjose.us", seen, out)
    _push("tivimate-vasteras.se", seen, out)
    ...
    _push("tivimate-oakville.ca", seen, out)
    _push("tivimate-burlington.ca", seen, out)
    _push("tivimate-bodo.no", seen, out)
    _push("tivimate-fredrikstad.no", seen, out)
    _push("tivimate-sandnes.no", seen, out)
    _push("tivimate-herning.dk", seen, out)
    ...
    _push("tivimate-holstebro.dk", seen, out)
    _push("tivimate-naestved.dk", seen, out)
    _push("tivimate-hameenlinna.fi", seen, out)
    _push("tivimate-belleville.ca", seen, out)
    _push("tivimate-sarnia.ca", seen, out)
    ...
    _push("tivimate-inuktitut.ca", seen, out)
    _push("tivimate-ojibwe.ca", seen, out)
    _push("tivimate-mikmaq.ca", seen, out)
    _push("tivimate-mohawk.ca", seen, out)
    ...
    _push("tivimate-gitxsan.ca", seen, out)
    _push("tivimate-nisgaa.ca", seen, out)
    _push("tivimate-tlingit.ca", seen, out)
    for stem in (
        "tivimate-hdr",
        "tivimate-pvr",
        "tivimate-timeshift",
    ...
    for stem in (
        ...
        "berkshire-tivimate",
        "buckingham-tivimate",
        "northampton-tivimate",
        "warwickshire-tivimate",
        "merseyside-tivimate",
        "tyneside-tivimate",
        "welsh-tivimate",
        "scots-tivimate",
        ...
        "ayrshire-tivimate",
        "lanarkshire-tivimate",
        "inverness-tivimate",
        "falkirk-tivimate",
        "dunfermline-tivimate",
        "paisley-tivimate",
        "kilmarnock-tivimate",
        "greenock-tivimate",
        "livingston-tivimate",
        "motherwell-tivimate",
        "cumbernauld-tivimate",
        "eastkilbride-tivimate",
        "wishaw-tivimate",
        "coatbridge-tivimate",
        "airdrie-tivimate",
        "kirkcaldy-tivimate",
        ...
        "largs-tivimate",
        "gourock-tivimate",
        "helensburgh-tivimate",
        "portglasgow-tivimate",
        "clydebank-tivimate",
        "milngavie-tivimate",
        "bearsden-tivimate",
        "johnstone-tivimate",
        ...
        "cairndow-tivimate",
        "strachur-tivimate",
        "tighnabruaich-tivimate",
        "colintraive-tivimate",
        "portbannatyne-tivimate",
        "innellan-tivimate",
        "sandbank-tivimate",
        "kilmun-tivimate",
        "strone-tivimate",
        ...
        "drymen-tivimate",
        "balmaha-tivimate",
        "rowardennan-tivimate",
        "killin-tivimate",
        "lochearnhead-tivimate",
        "comrie-tivimate",
        "crieff-tivimate",
        "auchterarder-tivimate",
        "blackford-tivimate",
        "dunkeld-tivimate",
        "pitlochry-tivimate",
        "aberfeldy-tivimate",
        ...
        "kinglassie-tivimate",
        "kelty-tivimate",
        "inverkeithing-tivimate",
        "dalgetybay-tivimate",
        "aberdour-tivimate",
        "burntisland-tivimate",
        "kinghorn-tivimate",
        "dysart-tivimate",
        "eastwemyss-tivimate",
        "westwemyss-tivimate",
        "leslie-tivimate",
        "springfield-tivimate",
        "balgonie-tivimate",
        "tillicoultry-tivimate",
        "tullibody-tivimate",
        "menstrie-tivimate",
        "alloa-tivimate",
        "clackmannan-tivimate",
        "sauchie-tivimate",
        "dollar-tivimate",
        "dunblane-tivimate",
        "bridgeofallan-tivimate",
        "doune-tivimate",
        "callander-tivimate",
        "aberfoyle-tivimate",
        "kippen-tivimate",
        ...
        "acharn-tivimate",
        "fortngall-tivimate",
        "rumblingbridge-tivimate",
        "yettsocochil-tivimate",
        "glendevon-tivimate",
        "muthill-tivimate",
        "braco-tivimate",
        "greenloaning-tivimate",
        "stfillans-tivimate",
        "dalginross-tivimate",
        "glenturret-tivimate",
        "ardtalnaig-tivimate",
        ...
        "logierait-tivimate",
        "ballinluig-tivimate",
        "killiecrankie-tivimate",
        "blairatholl-tivimate",
        "calvine-tivimate",
        ...
        "carrbridge-tivimate",
        "grantown-tivimate",
        "nethybridge-tivimate",
        "boatofgarten-tivimate",
        ...
        "glendullan-tivimate",
        "speyburn-tivimate",
        "glentauchers-tivimate",
        "inchgower-tivimate",
        "strathmill-tivimate",
        "auchroisk-tivimate",
        "glenglassaugh-tivimate",
        "mannochmore-tivimate",
        "glenkeith-tivimate",
        "balmenach-tivimate",
        "alltabhainne-tivimate",
        "glenburgie-tivimate",
        "braeval-tivimate",
        "tormore-tivimate",
        "tamnavulin-tivimate",
        ...
        "balblair-tivimate",
        "wolfburn-tivimate",
        "oldpulteney-tivimate",
        "bennevis-tivimate",
        "dalmore-tivimate",
        "talisker-tivimate",
        "edradour-tivimate",
        "glenmorangie-tivimate",
        "ardmore-tivimate",
        "lagavulin-tivimate",
        "laphroaig-tivimate",
        "bunnahabhain-tivimate",
        "caolila-tivimate",
    ):
