...
def main() -> None:
    ...
    extra = [
        ...
        ("France", "fr", "iptv fibre", "isp", "fr_isp"),
        ("France", "fr", "iptv tnt", "broadcast", "fr_broadcast"),
        ("France", "fr", "iptv parabole", "broadcast", "fr_broadcast"),
        ("Switzerland", "fr", "iptv romand", "geo_lang", "ch_fr"),
        ("Belgium", "fr", "iptv wallonie", "geo_lang", "be_fr"),
        ("United Kingdom", "en", "iptv box uk", "device", "uk_seo_only"),
        ("France", "fr", "iptv wifi", "device", "fr_device"),
        ("United States", "en", "hdmi iptv", "device", "us_device"),
        ("Canada", "en", "iptv kitchener", "city", "ca_city"),
        ("France", "fr", "iptv cinema", "content", "fr_content"),
        ("France", "fr", "iptv anime", "content", "fr_content"),
        ("United States", "en", "anime iptv", "content", "us_content"),
        ("United States", "en", "iptv series", "content", "us_content"),
        ("France", "fr", "iptv foot", "sport", "fr_sport"),
        ("France", "fr", "iptv rugby", "sport", "fr_sport"),
        ("United States", "en", "nba iptv", "sport", "us_sport"),
        ...
        ("France", "fr", "iptv formule 1", "sport", "fr_sport"),
        ("United States", "en", "f1 iptv", "sport", "us_sport"),
        ("United States", "en", "wwe iptv", "sport", "us_sport"),
        ("United States", "en", "motogp iptv", "sport", "us_sport"),
        ("Norway", "no", "iptv norsk", "local_language", "no_local"),
        ...
        ("France", "fr", "iptv normandie", "geo", "fr_geo"),
        ("France", "fr", "iptv savoie", "geo", "fr_geo"),
        ("Germany", "de", "iptv bayern", "geo", "de_geo"),
        ("Netherlands", "nl", "iptv brabant", "geo", "nl_geo"),
        ("Netherlands", "nl", "iptv limburg", "geo", "nl_geo"),
        ("Germany", "de", "iptv nrw", "geo", "de_geo"),
        ("Germany", "de", "iptv hessen", "geo", "de_geo"),
        ("France", "fr", "iptv languedoc", "geo", "fr_geo"),
        ("Switzerland", "it", "iptv ticino", "geo", "ch_it"),
        ("Finland", "fi", "iptv lapland", "geo", "fi_geo"),
        ("France", "fr", "iptv catalan", "geo_lang", "fr_cat"),
        ("France", "fr", "iptv basque", "geo_lang", "fr_eu"),
        ("Belgium", "fr", "iptv wallon", "geo_lang", "be_fr"),
        ("Norway", "no", "sami iptv", "geo_lang", "no_sami"),
        ("Sweden", "sv", "sami iptv", "geo_lang", "se_sami"),
        ("France", "fr", "iptv amazigh", "geo_lang", "fr_maghreb"),
        ("France", "fr", "iptv kabyle", "geo_lang", "fr_maghreb"),
        ("France", "fr", "iptv antilles", "geo", "fr_ov"),
